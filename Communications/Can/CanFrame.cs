...
{
    /// <summary>CAN-сообщение</summary>
    public class CanFrame : IDataFrame
    {
        /// <summary>Максимальное значение идентификатора CAN-фрейма</summary>
        ...
        /// <summary>Дескриптор сообщения</summary>
        public int Descriptor
        {
            get { return GetDescriptorFor(Id, Data.Length); }
        }

        /// <summary>Показывает, является ли данный пакет Loopback-пакетом</summary>
        public bool IsLoopback { get; set; }

        /// <summary>Время получения или время создания фрейма</summary>
        public DateTime Time { get; set; }

        /// <summary>Является ли этот фрейм обработанным</summary>
        /// <remarks>
        ///     При передаче принятого пакета по стеку, можно использовать для того, чтобы отметить пакет, на который уже
        ...
        /// <summary>Создаёт CAN-сообщение с заданным ID</summary>
        ...
        /// <summary>Создаёт пустое CAN-сообщение с заданными ID и длиной</summary>
        /// <param name="Id">Идентификатор сообщения</param>
        ...
        /// <summary>Создаёт CAN-сообщение с заданным Дескриптором</summary>
        ...
        /// <summary>Создаёт пустое CAN-сообщение с заданным Дескриптором</summary>
        /// <param name="Descriptor">Дескриптор сообщения</param>
        ...
        /// <summary>Создаёт новую объект фрейма</summary>
        ...
        /// <summary>Создаёт Loopback-пакет для данного</summary>
